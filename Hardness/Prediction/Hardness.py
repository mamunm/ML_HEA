"""
A script to select Machine Learning Models for Hardness Prediction.
"""
...
class Hardness:
   ...
   def feature_importance(self):
           #lasso = LassoCV().fit(self.scaled_features,self.labels)
           importance = np.abs(self.fitted_model.coef_) #list(self.fitted_model.feature_importances_)                               # Extracting the feature importances
...
# Testing set
    ...
    def test(self,validation_data):
        ...
        predictions.columns = ['Alloy','True Hardness',self.model_name]
